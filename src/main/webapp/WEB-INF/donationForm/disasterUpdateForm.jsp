...
<head>
    ...
    <title>DisasterUpdateForm</title>
    <style>
       .container {
            width: 70%;
            margin: 0 auto;
           ...
           <input type="hidden" name="userId" value="${article.userId }">
            ...
            <div>
                ...
                <c:if test="${'태풍' eq article.type }">
                   ...
                   <input type="radio" name="type" value="기타" id="type5"><label for="type5">기타</label>
                </c:if>
                ...
                <c:if test="${'기타' eq article.type }">
                   <input type="radio" name="type" value="태풍" id="type1"><label for="type1">태풍</label>
                   <input type="radio" name="type" value="지진" id="type2"><label for="type2">지진</label>
                   <input type="radio" name="type" value="가뭄" id="type3"><label for="type3">가뭄</label>
                   <input type="radio" name="type" value="홍수" id="type4"><label for="type4">홍수(폭우)</label>
                   <input type="radio" name="type" value="기타" id="type5" checked="checked"><label for="type5">기타</label>
                </c:if>
            </div>
            ...
            <div>
                ...
                <br>
                <input type="number" id="damage_amount" value="${article.damage_amount }">(단위: 원)
            </div>
            ...
            <div>
                ...
                <br>
                <input type="file" id="receipt_img" name="receipt_img" multiple="multiple">
            </div>

            <div class="btn">
                <input type="button" value="Create" onClick="DisasterArticleUpdate()">
            </div>
        </form>
    </div>
</body>
